...
XML::Compile::SOAP::Trace-E<gt>B<new>(OPTIONS)
...
$obj-E<gt>B<printRequest>([FILEHANDLE])

=over 4

=back

$obj-E<gt>B<printResponse>([FILEHANDLE])

=over 4

=back

$obj-E<gt>B<printTimings>([FILEHANDLE])
