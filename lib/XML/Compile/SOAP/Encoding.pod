...
use L<typed()|XML::Compile::SOAP::Encoding/"Encoding">.
...
Convenience alternative for L<encAddNamespaces()|XML::Compile::SOAP::Encoding/"Encoding">.
...
L<startEncoding()|XML::Compile::SOAP::Encoding/"Encoding"> is called, the table is reset.  The namespace
table is returned.
...
are added to the list on the top-level.  See L<compileMessage(prefixes)|XML::Compile::SOAP/"Single messages">.
...
. namespaces => HASH|ARRAY

=over 4

Like L<XML::Compile::Schema::compile(output_namespaces)|XML::Compile::Schema/"Compilers">, this can
...
defined by the selected schema (see L<new(schema_ns)|XML::Compile::SOAP/"Constructors">).  If you explicitly
...
The decoded data is returned.  When L<startDecoding(simplify)|XML::Compile::SOAP::Encoding/"Decoding"> is true,
...
Simplify the TREE of output produced by L<dec()|XML::Compile::SOAP::Encoding/"Decoding"> to contain only
...
Call L<decSimplify()|XML::Compile::SOAP::Encoding/"Decoding"> automatically at the end of L<dec()|XML::Compile::SOAP::Encoding/"Decoding">, so producing
...
This module is part of XML-Compile-SOAP distribution version 0.65,
