...
Operations are often modified by SOAP extensions. See XML::Compile::WSA,
for instance.

$obj-E<gt>B<addHeader>(('INPUT'|'OUTPUT'|'FAULT'), LABEL, ELEM)
...
XML::Compile::SOAP11::Operation-E<gt>B<register>(URI, ENVNS)
...
built on August 11, 2010. Website: F<http://perl.overmeer.net/xml-compile/>
