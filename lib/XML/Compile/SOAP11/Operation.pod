...
=item $obj-E<gt>B<addHeader>(('INPUT'|'OUTPUT'|'FAULT'), LABEL, ELEM)
...
This module is part of XML-Compile-SOAP distribution version 2.25,
built on September 22, 2011. Website: F<http://perl.overmeer.net/xml-compile/>
