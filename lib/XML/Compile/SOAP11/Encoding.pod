...
are added to the list on the top-level.  See XML::Compile::SOAP subroutine compileMessage option prefixes.
...
defined by the selected schema (see XML::Compile::SOAP subroutine new option schema_ns).  If you explicitly
