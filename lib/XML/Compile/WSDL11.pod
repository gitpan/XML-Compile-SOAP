...
Creates temporarily an L<XML::Compile::SOAP::Operation|XML::Compile::SOAP::Operation> object with
...
L<XML::Compile::SOAP::Operation::compileClient()|XML::Compile::SOAP::Operation/"Handlers"> (a whole lot,
...
This module is part of XML-Compile-SOAP distribution version 2.18,
