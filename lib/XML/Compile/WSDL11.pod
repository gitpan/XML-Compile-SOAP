...
$obj-E<gt>B<call>(OPERATION, DATA)
...
$obj-E<gt>B<compileAll>(['READERS'|'WRITERS'|'RW'|'CALLS', [NAMESPACE]])
...
$obj-E<gt>B<compileCalls>(OPTIONS)
...
$obj-E<gt>B<declare>(GROUP, COMPONENT|ARRAY, OPTIONS)
...
$obj-E<gt>B<explain>(OPERATION, FORMAT, DIRECTION, OPTIONS)
...
$obj-E<gt>B<findDef>(CLASS, [QNAME|PREFIXED|NAME])
...
This module is part of XML-Compile-SOAP distribution version 2.21,
built on December 25, 2010. Website: F<http://perl.overmeer.net/xml-compile/>
