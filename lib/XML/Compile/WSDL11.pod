...
L<XML::Compile::Schema::template()|XML::Compile::Schema/"Compilers"> may help you.

When the definitions are spread over multiple files, you will need to
use L<addWSDL()|XML::Compile::WSDL11/"Extension"> (wsdl), or L<importDefinitions()|XML::Compile::WSDL11/"Extension"> (additional schema's)
...
XML::Compile::WSDL11-E<gt>B<addSchemaDirs>(DIRECTORIES|PACKAGE)
...
L<XML::Compile::WSDL11::Operation::compileClient()|XML::Compile::WSDL11::Operation/"Handlers"> (a whole lot,
