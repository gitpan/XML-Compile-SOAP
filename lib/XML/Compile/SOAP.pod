...
The CODE reference is produced by L<compileMessage()|XML::Compile::SOAP/"Single messages">, and must be a
...
=head2 Using SOAP calls

=head3 Naming types and elements
