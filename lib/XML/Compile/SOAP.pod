...
the predefined actors/roles, like 'NEXT'.  See L<roleAbbreviation()|XML::Compile::SOAP/"Helpers">.
...
L<writerConvertFault()|XML::Compile::SOAP/"Sender (internals)"> is used to hide the differences.
