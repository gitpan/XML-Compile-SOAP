...
L<XML::Compile::Schema::importDefinitions()|XML::Compile::Schema/"Administration"> for this SOAP object's
schema with all the parameters provided.  XMLDATA can be everything
accepted by L<XML::Compile::dataToXML()|XML::Compile/"Compilers"> plus an ARRAY of these things.
