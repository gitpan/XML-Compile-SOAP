...
See L<documentation in base class|XML::Compile::Transport/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|XML::Compile::Transport/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|XML::Compile::Transport/"Constructors">.
...
See L<documentation in base class|XML::Compile::Transport/"WSDL11">.
...
See L<documentation in base class|XML::Compile::Transport/"SOAP11">.
...
See L<documentation in base class|XML::Compile::Transport/"Accessors">.
...
See L<documentation in base class|XML::Compile::Transport/"Handlers">.
...
See L<documentation in base class|XML::Compile::Transport/"DETAILS">.
 
=head1 SYNOPSYS

See L<documentation in base class|XML::Compile::Transport/"SYNOPSYS">.
 
=head1 Helpers

See L<documentation in base class|XML::Compile::Transport/"Helpers">.
...
This module is part of XML-Compile-SOAP distribution version 2.36,
