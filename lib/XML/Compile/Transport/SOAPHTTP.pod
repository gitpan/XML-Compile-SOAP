...
XML::Compile::Transport::SOAPHTTP-E<gt>B<wsdl11Init>(WSDL, ARGS)
...
XML::Compile::Transport::SOAPHTTP-E<gt>B<soap11OperationInit>(OPERATION, ARGS)
...
$obj-E<gt>B<userAgent>([AGENT|(undef, OPTIONS)])
