...
See L<documentation in base class|XML::Compile::SOAP/"SOAP introduction">.
 
=head2 Naming types and elements

See L<documentation in base class|XML::Compile::SOAP/"Naming types and elements">.
 
=head2 Client and Server implementations

See L<documentation in base class|XML::Compile::SOAP/"Client and Server implementations">.
 
=head2 Use of wildcards (any/anyAttribute)

See L<documentation in base class|XML::Compile::SOAP/"Use of wildcards (any/anyAttribute)">.
