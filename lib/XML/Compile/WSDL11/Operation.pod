...
explicitly a prototype for the call.  See XML::Compile::WSDL11::Operation subroutine rpcPrototype ???
...
$obj-E<gt>B<prepareClient>(OPTIONS)
...
Passed to L<XML::Compile::SOAP::HTTPClient::new(transport_hook)|XML::Compile::SOAP::HTTPClient/"METHODS">.  Can be
used to create off-line tests and last resort work-arounds.  See also
the DETAILs chapter in the L<XML::Compile::SOAP::HTTPClient|XML::Compile::SOAP::HTTPClient> manual pag.e
...
This module is part of XML-Compile-SOAP distribution version 0.56,
built on October 12, 2007. Website: F<http://perl.overmeer.net/xml-compile/>
