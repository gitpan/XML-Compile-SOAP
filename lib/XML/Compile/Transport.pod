...
See L<documentation in base class|XML::Compile::SOAP::Extension/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|XML::Compile::SOAP::Extension/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|XML::Compile::SOAP::Extension/"Constructors">.
...
See L<documentation in base class|XML::Compile::SOAP::Extension/"WSDL11">.
...
See L<documentation in base class|XML::Compile::SOAP::Extension/"SOAP11">.
...
See L<documentation in base class|XML::Compile::SOAP::Extension/"SYNOPSYS">.
